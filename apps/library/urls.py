...
from apps.library.views import CategoryViewSet, PostViewSet, BookViewSet
from apps.library.views.viewsets_views import create_author_with_book
...
urlpatterns = [
    ...
    path('author/', create_author_with_book, name='author'),
]
